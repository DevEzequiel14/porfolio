...
@Component({
  selector: 'app-svg-django',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" width="800" height="800"
    viewBox="0 0 32 32" [attr.width]="size.width" [attr.height]="size.height">
    ...
    <path d="M24.4 10.059v9.1c0 3.133-.235 4.639-.923 5.938A6.316 6.316 0 0 1 20.237 28l-3.678-1.733a5.708 5.708 0 0 0 3.141-2.629c.566-1.121.745-2.42.745-5.837v-7.742ZM20.441 4.02h3.964v4.028h-3.964z" style="fill:#44b78b"/></svg>
  `,
})
export class SvgDjangoComponent {
