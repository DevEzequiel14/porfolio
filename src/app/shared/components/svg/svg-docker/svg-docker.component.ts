...
@Component({
  selector: 'app-svg-docker',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#008fe2" [attr.width]="size.width" [attr.height]="size.height">
...
export class SvgDockerComponent {
