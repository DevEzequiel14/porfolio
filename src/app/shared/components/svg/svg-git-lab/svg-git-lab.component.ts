...
@Component({
  selector: 'app-svg-git-lab',
  standalone: true,
  template: `
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="tanukiHomeDesktop" [attr.width]="size.width" [attr.height]="size.height">
...
export class SvgGitLabComponent {
