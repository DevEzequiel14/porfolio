...
@Component({
  selector: 'app-svg-swagger',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256" [attr.width]="size.width" [attr.height]="size.height">
...
export class SvgSwaggerComponent {
